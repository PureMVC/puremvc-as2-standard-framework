...
class org.puremvc.as2.core.controller.Controller implements IController{
	 ...
	 * 
	 * AS2 Note: Unlike the AS3 version, executeCommand uses a cached instance of an ICommand rather than creating a new istance using a class reference.
	 *
	 ...
	 *
	 * AS2 Note: Unlike the AS3 version, registerCommand takes an instance of an ICommand rather than a class reference.  
	 * This instance is then reused every time the Command is called, so it is important that it remains stateless.
	 * 
